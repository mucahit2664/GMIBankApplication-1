...
public class Customer {
    ...
    public Customer(Integer id, String firstName, String lastName,Country country, String state) {
        this.id = id;
        this.firstName = firstName;
        this.lastName = lastName;
        this.country = country;
    ...
    public Customer(Integer id, String firstName, String lastName, String middleInitial, String email, String mobilePhoneNumber, String phoneNumber, String zipCode, String address, String city, String ssn, String createDate, Boolean zelleEnrolled, Country country, String state, BIConversion.User user, Object accounts) {
        this.id = id;
        this.firstName = firstName;
        this.lastName = lastName;
        this.middleInitial = middleInitial;
